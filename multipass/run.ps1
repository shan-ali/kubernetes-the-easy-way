#start vms
echo "Starting VMs"
multipass launch --cloud-init cloud-config.yml --disk 10G --mem 1G --cpus 1 --name controller-1
multipass launch --cloud-init cloud-config.yml --disk 10G --mem 1G --cpus 1 --name controller-2
multipass launch --cloud-init cloud-config.yml --disk 5G --mem 1G --cpus 1 --name loadbalancer
multipass launch --cloud-init cloud-config.yml --disk 5G --mem 1G --cpus 1 --name worker-1
multipass launch --cloud-init cloud-config.yml --disk 5G --mem 1G --cpus 1 --name worker-2
echo ""
